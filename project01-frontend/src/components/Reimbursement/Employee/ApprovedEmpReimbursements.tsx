...
export const ApprovedEmpReimbursements:React.FC = () => {
    const [reimbs, setReimbs] = useState([])
    const navigate = useNavigate()

    useEffect(() => {
        axios.get("http://localhost:8080/reimbs/approved", {withCredentials:true})
        .then((response) => {
        ...
        <div>
            {
                ...
                <div className="welcome">
                    There are no approved reimbursements found yet!
                </div> :
